    ...
    <section id="experience">
        ...
        <div id='division2'></div>
          ...
          <i className="fa-solid fa-user-graduate"></i>
            ...
            <p className="card-para">Full MERN Stack (MongoDB * Express * React.js * Node.js)</p>
            </div>
          </div>
          <div className="card">
          <i className="fa-solid fa-user-graduate"></i>
          ...
          <i className="fa-solid fa-scroll"></i>
            ...
            <a  href="https://www.credly.com/badges/7ceb21ff-d90e-47a6-8a53-3750bf720d35?source=linked_in_profile" className="card-para">View credential</a>
            </div>
          </div>
          <div className="card">
          <i className="fa-solid fa-scroll"></i>
            ...
            <a href="https://tealprod.tea.state.tx.us/ECOS-External/EcosOnline/VirtCert#current" className="card-para">View credential</a>
            </div>
          </div>
